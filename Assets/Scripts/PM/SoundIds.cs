...
internal static class SoundIds 
{
    ...
    {
        internal const string
            Blue = "PointlessMachinesBlue",
            Loop = "PointlessMachinesLoop",
            Purple = "PointlessMachinesPurple",
            Red = "PointlessMachinesRed",
            Reset = "PointlessMachinesReset",
            Solve = "PointlessMachinesSolve",
            White = "PointlessMachinesWhite",
            Yellow = "PointlessMachinesYellow";

        internal static string Direction(int i)
        {
            return "PointlessMachines".Add(i + 1).Add("abc".PickRandom());
        }
    }
